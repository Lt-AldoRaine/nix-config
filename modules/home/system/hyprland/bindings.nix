...
=======
  ...
  execEntries = map (b: mkBind "${mod} + ${b.key}" (hlLib.dsp.exec b.cmd)) execBinds;

  focusEntries = map (b: mkBind "${mod} + ${b.key}" (hlLib.dsp.focus b.dir)) directions;
